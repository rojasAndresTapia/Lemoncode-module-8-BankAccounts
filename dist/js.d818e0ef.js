...
},{}],"src/js/styles-business.js":[function(require,module,exports) {
...
},{}],"src/js/account-business.js":[function(require,module,exports) {
...
var Styles = require('./styles-business');
...
function getAccountElement(account) {
  ...
  var ibanNumber = document.createElement('span');
  var saldo = document.createElement('span');
  var iban = document.createElement('span');
  span.style = Styles.getNodeStyle(account);
  saldo.append(" SALDO");
  iban.append(" IBAN");
  money.append("".concat(account.money, " \u20AC"));
  ibanNumber.append(" ".concat(account.iban, " "));
...
},{"./styles-business":"src/js/styles-business.js"}],"src/js/client-business.js":[function(require,module,exports) {
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
var ClientsElements = require('./account-business');
...
function getClientElement(client) {
  ...
  var div = ClientsElements.getClientAccountsElement(clientAccounts);
...
function getFullName(client) {
  ...
  paragraph.append(" ".concat(client.first_name, " ").concat(client.last_name, " "));
...
},{"./data-business":"src/js/data-business.js","./account-business":"src/js/account-business.js"}],"src/js/client-list-business.js":[function(require,module,exports) {
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
},{"./data-business":"src/js/data-business.js","./client-business":"src/js/client-business.js"}],"src/js/index.js":[function(require,module,exports) {
var PrintAccounts = require("./client-list-business");

window.onload = function () {
  PrintAccounts.printClientsAccounts();
};
},{"./client-list-business":"src/js/client-list-business.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
